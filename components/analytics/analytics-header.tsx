    ...
    <>
      ...
      <div className="flex items-center gap-2 mt-3">
        ...
        <div className="relative">
          <select
            value={isSuperAdmin 
              ? (selectedGroupId === "all" ? "all" : selectedGroupId?.toString() || "all")
              : (spocGroupIds[0]?.toString() || "")
            }
            ...
            className={`
              ...
              rounded-lg px-4 py-2 pr-10 text-sm font-medium
            ...
            {isSuperAdmin ? (
              ...
              <>
                {spocGroupIds.length > 0 ? (
                  ...
                  <option value={userGroupId || ""}>{groupName || "N/A"}</option>
                )}
              </>
            )}
          </select>
