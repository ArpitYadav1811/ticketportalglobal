...
export default function AddTeamMemberModal({
 ...
 {/* Modal */}
 <div className="relative bg-white rounded-xl w-full max-w-lg mx-4 max-h-[80vh] flex flex-col">
 {/* Header */}
 ...
 disabled={adding}
 className="px-3 py-1.5 text-sm font-medium text-primary border border-primary rounded-lg hover:bg-black hover:text-white transition-colors disabled:opacity-50"
 >
 Add
 </button>
 )}
